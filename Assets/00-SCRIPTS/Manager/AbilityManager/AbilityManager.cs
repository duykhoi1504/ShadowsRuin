...
public class AbilityManager : Singleton<AbilityManager>
{
    ...
    [SerializeField] bool isShowAbilityUse = false;
    ...
    {
        // abilities=gameContentSO.Abilities;
        abilities.Clear();
        foreach (Ability a in gameContentSO.Abilities)
        {
            if (a.IsBuy == true)
            {
                abilities.Add(a);
    ...
    // public void ListAbilitys(bool canUpdate)
    // {
